                    ...
                    new InfoListSection(
                      ...
                      child: new StreamBuilder<QuerySnapshot>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          for (var i = 0;
                              i <
                                  (snapshot.data.documents.length / 3).ceil() *
                                      3;
                              i++) {
                            if (i % 3 == 0) {
                              rows.add([]);
                                    ...
                                    children: <Widget>[
                                      Padding(
                                        ...
                                        child: RawMaterialButton(
                                          ...
                                          onPressed: () {
                                            print('tap');
                                            launch(snapshot.data.documents[i]
                                                ['url']);
                                          },
                                          child: ClipRRect(
                                            borderRadius:
                            ...
                            builder: (context, snapshot) {
                              ...
                              return new Column(
                                ...
                                children: snapshot.data.documents
                                    .sublist(0,
                                        min(snapshot.data.documents.length, 2))
                                    .map((document) {
                                  return Column(
                                    children: <Widget>[
                          ...
                          new Row(
                            ...
                            children: <Widget>[
                              new FlatButton(
                                  onPressed: () {
                                    addQuestion(
                                        context, _nameDialogTextController);
                                  },
    ...
    return new ListTile(
      onTap: () {
        Navigator.of(context).push(new MaterialPageRoute(
            builder: (context) => new QuestionAnswersPage(document.reference)));
      },
      ...
      trailing: new Text(computeHowLongAgoTextShort(
          (document['timestamp'] as Timestamp).toDate())),
    );
  }
}

final GlobalKey<FormState> _addQuestionDialogFormKey =
    new GlobalKey<FormState>();

Future<bool> isUserRegistered(BuildContext context,
    TextEditingController nameController, bool prompt) async {
...
class _QuestionProfilePageState extends State<QuestionProfilePage> {
  ...
  final TextEditingController _adminUsernameTextController =
      new TextEditingController();
  final TextEditingController _adminPasswordTextController =
      new TextEditingController();
                                ...
                                if (_adminFormKey.currentState.validate()) {
                                  FirebaseAuth.instance
                                      .signInWithEmailAndPassword(
                                          email:
                                              _adminUsernameTextController.text,
                                          password:
      ...
      appBar: new AppBar(
        ...
        actions: <Widget>[
          IconButton(
            ...
            onPressed: () {
              Navigator.of(context).push(new MaterialPageRoute(
                  builder: (context) => new QuestionProfilePage(),
                          ...
                          children: <Widget>[
                            new ListTile(
                              ...
                              subtitle: new StreamBuilder(
                                stream: Firestore.instance
                                    .collection(
                                        'questions/${document.documentID}/answers')
                                    .snapshots(),
                                builder: (context, snapshot) {
                                  if (snapshot.hasData &&
                              ...
                              onTap: () {
                                Navigator.of(context).push(
                                  ...
                                  return new QuestionAnswersPage(
                                      document.reference);
                                }));
                              },
                            ),
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, user) {
                ...
                return new Text('Asked by $userText',
          ...
          Padding(
            padding: const EdgeInsets.symmetric(vertical: 4.0),
            child: new Text(
              computeHowLongAgoText(
                  (snapshot.data['timestamp'] as Timestamp).toDate()),
              style: new TextStyle(color: Colors.white),
            ),
          )
        ],
                      ...
                      actions: <Widget>[
                        new FutureBuilder<FirebaseUser>(
                            ...
                            builder: (context, user) {
                              if (user != null &&
                                  user.hasData &&
                                  (user.data.uid == snapshot.data['uid'] ||
                                  ...
                                  onPressed: () async {
                                    ...
                                    if ((result != null && result)) {
                                      Firestore.instance.runTransaction(
                                        (transaction) async {
                                          await transaction
                                              .delete(widget.documentReference);
                      ...
                      child: FutureBuilder<FirebaseUser>(
                        ...
                        builder: (context, user) {
                          ...
                          return new StreamBuilder<QuerySnapshot>(
                            stream: Firestore.instance
                                .collection(
                                    'questions/${snapshot.data.documentID}/answers')
                                .orderBy('timestamp', descending: true)
                                .snapshots(),
                            builder: (context, answersSnapshot) {
                              ...
                              List<DocumentSnapshot> answers =
                                  answersSnapshot.data.documents;
