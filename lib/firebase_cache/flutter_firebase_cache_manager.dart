...
class CacheManager {
  ...
  CacheManager._(String bucket)
      : this._firebaseStorage = new FirebaseStorage(storageBucket: bucket);
  ...
  Future<CacheObject> _downloadFile(
    ...
    StorageMetadata metadata =
        await _firebaseStorage.ref().child(url).getMetadata();
  ...
  static synchronized(Object lock, Future<Null> Function() param1) {}
}

class CacheObject {
  CacheObject(String url, {Object lock});

  CacheObject.fromMap(key, data);
  ...
  setDataFromHeaders(Map<String, String> map) {}
}
